...
Es una empresa dedicada a las artes graficas, llevan 20 anos de fundada, tienen multiples sedes en 3 paises distintoss

Tienen puntos fisicos
...
1. Toma de fotografias 
2. Revelado de rollos
3. Impresion digital

Sus estudios fotograficos, son orientados a familia
...
- Operacion con mas volumen, 50% de ventas y 20% utilidad

### Revelado de rollos

1. Entrega rollo
2. Cancela y recibe comprobante
3. 3 dias despues vuelve con su comprobante y ya

Estos deben ser llevados a un lugar por alguien

- Operacion 10% de las ventas totales, costoso generados son mas grandes que las ventas
...
- Cuenta con proveedores de estampados y marqueteria. Esto se realiza en el centro de produccion

- Proceso dura 5 y 8 dias
...
- 100 consultas per seg
### Manejo del pago

- Debe recibir un numero de confirmacion
	- Seguimiento de su orden
- Tiempo de respuesta < 2seg
- Correo de confirmacion < 5seg
...
- Venta debe actualizar el inventario < 1 seg
...
- Debe tener en cuenta numero de hojas y las fotograficas ubicadas (la mayor cantidad de fotos en el menor espacio posible)
